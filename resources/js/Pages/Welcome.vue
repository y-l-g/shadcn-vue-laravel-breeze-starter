        ...
        <div class="flex-1 bg-background">
            <main class="container mt-10">
                <Transition
                    ...
                    mode="out-in"
                >
                    <div class="gap-6 lg:gap-8 rounded-lg grid lg:grid-cols-2">
                        <a
                            href="https://laravel.com/docs"
                            id="docs-card"
                            class="flex flex-col items-start gap-6 overflow-hidden rounded-lg bg-white p-6 shadow-md border-black/5 border ring-1 ring-white/[0.05] transition duration-300 hover:text-black/60 hover:ring-black/5 focus:outline-none focus-visible:ring-[#FF2D20] md:row-span-3 lg:p-10 lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20] "
                        >
                            <div
                            ...
                            >
                                <img
                                    ...
                                    class="aspect-video h-full w-full flex-1 rounded-[10px] object-cover object-top drop-shadow-md dark:hidden"
                                    @error="handleImageError"
                                />
                                <img
                                    src="https://laravel.com/assets/img/welcome/docs-dark.svg"
                                    alt="Laravel documentation screenshot"
                                    class="hidden aspect-video h-full w-full flex-1 rounded-[10px] object-cover object-top drop-shadow-md dark:block"
                                />
                                <div
                            ...
                            <div class="relative flex items-center gap-6 lg:items-end">
                                ...
                                >
                                    ...
                                    <div class="pt-3 sm:pt-5 lg:pt-0">
                                        ...
                                        <p class="mt-4 text-sm/relaxed text-primary/80">
                        ...
                        <a
                            ...
                            class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-md border-black/5 border ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/5 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]"
                        >
                            <div
                                class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                                <svg
                        ...
                        <div
                            class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-md border-black/5 border ring-1 ring-white/[0.05] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800">
                            <div
                                class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                                <svg
                                    class="size-5 sm:size-6"
